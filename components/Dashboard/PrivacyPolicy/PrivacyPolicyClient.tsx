    ...
    <div className="w-full flex-1 flex flex-col">
      ...
      <div className="flex flex-col gap-8 flex-1">
        ...
        <button
          ...
          className="w-full border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-6 flex items-center justify-center gap-2 text-gray-500 dark:text-gray-400 font-medium hover:bg-gray-50 dark:hover:bg-gray-700/50 hover:border-gray-400 dark:hover:border-gray-500 transition-colors"
        >
